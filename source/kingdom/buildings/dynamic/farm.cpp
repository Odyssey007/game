...
Farms::Farms() {
    ...
    bounds.top = 700;   // Will be loaded from the saved data
...
std::string Farms::getName() {
    return "Farm"; 
}

sf::Vector2f Farms::getPosition() {
